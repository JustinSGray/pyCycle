...
ref_data = np.loadtxt(os.path.join(fpath, '..', '..', 'test_data', 'inlet.csv'), delimiter=",", skiprows=1)
...
class NewInletTestCase(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        cycle.add_subsystem('inlet', NewInlet())
